      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navigation">
           ...
           <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="#">Add Grading System</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="#">All Grading System</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="#">Manage Grading Effort</a>
            </li>
